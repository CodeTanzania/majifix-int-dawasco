...
exports.normalizeAccount = function normalizeAccount(account) {
  ...
  //map phone to E164
  account.phone = _.isEmpty(account.phone) ? DEFAULT_PHONE_NUMBER : account.phone
...
exports.getCustomerDetails =
  function getCustomerDetails(accountNumber, done, txn) {
...
exports.getAccount = function getAccount(accountNumber, done, txn) {
  ...
  async.parallel({
    ...
    bills: function fetchBillHistory(next) {
      exports.getBillHistory(accountNumber, next, txn);
    }
...
exports.getNumbers =
  function getNumbers(
    offset = DEFAULT_OFFSET, limit = DEFAULT_LIMIT, txn = undefined
  ) {
    ...
    return (txn || instance).raw(ACCOUNT_NUMBERS_QUERY).stream();
 ...
 * @static
 */
exports.getCounts = function getCounts(done, txn) {
