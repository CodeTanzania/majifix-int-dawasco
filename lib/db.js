...
exports.getUserDetails = function getUserDetails(accountNumber, done) {
  ...
  instance.raw(USER_DETAILS_QUERY).asCallback(function (error, results) {
    if (!error && results) {
...
exports.getAccountDetails = function getAccountDetails(accountNumber, done) {
  ...
  instance.raw(ACCOUNT_DETAILS_QUERY).asCallback(function (error, results) {
    if (!error && results) {
 ...
 * @static
 */
exports.getCustomerDetails = function getCustomerDetails(accountNumber, done) {
  ...
  instance.raw(CUSTOMER_DETAILS_QUERY).asCallback(function (error, results) {
    if (!error && results) {
      results = _.merge({}, results[0]);
      results = exports.normalizeAccount(results);
    }
...
exports.getBillHistory = function getBillHistory(accountNumber, done) {
  ...
  instance.raw(BILL_HISTORY_QUERY).asCallback(function (error, results) {
    if (!error && results) {
...
exports.getAccount = function getAccount(accountNumber, done) {
  ...
  async.parallel({
    ...
    account: function fetchAccountDetails(next) {
      exports.getAccountDetails(accountNumber, next);
    },
    ...
    accessors: function fetchAccessorDetails(next) {
      exports.getUserDetails(accountNumber, next);
    },

    bills: function fetchBillHistory(next) {
      exports.getBillHistory(accountNumber, next);
    }
