...
/* @todo add total payments per bill period */
...
const CURRENT_BILL_TABLE_NAME = '[dbo].[spotbills_from_Gepg_new]';
const PREVIOUS_BILL_TABLE_NAME = '[dbo].[spotbills_from_Gepg_previous]';
...
exports.getBillHistory = function getBillHistory(accountNumber, done) {
  ...
  const CURRENT_BILL_QUERY =
    ...
    LTRIM(RTRIM(b.GEPG_CONTROL_NO)) AS number,
